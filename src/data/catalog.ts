...
export const syncedArticles: SyncedArticle[] = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        size: "38 KB",
        status: "待补链",
        note: "可放自制检查清单、配置说明，不放未授权模型或破解包。",
      },
      {
        id: 103,
        title: "常见报错排查表",
